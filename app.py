...
def compound_interest(principal, rate, time, monthly_investment):
    ...
    interest = total_amount - (principal + monthly_investment * int(12 * time))
...
# User input section
principal_amount = st.number_input("Enter the principal amount:", min_value=0.0, step=100.0)
interest_rate = st.number_input("Enter the annual interest rate (%):", min_value=0.0, step=0.1)
investment_time = st.number_input("Enter the investment time in years:", min_value=0.0, step=0.5)
monthly_investment = st.number_input("Enter additional monthly investment:", min_value=0.0, step=50.0)
